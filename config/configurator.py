...
# @Email  : 21122587r@connect.polyu.hk
...
from Models.evaluator import metric_types, smaller_metrics
from utils import get_model, Enum, EvaluatorType, ModelType, InputType, \
...
class Config(object):
    ...
    Configurator module will first load the default parameters from the fixed properties in Models and then
